package com.transform.utils.toPdf.component;
...
import com.transform.utils.toPdf.component.builder.FreeMarkerUtil;
import com.transform.utils.toPdf.component.builder.HeaderFooterBuilder;
import com.transform.utils.toPdf.component.builder.PDFBuilder;
...
public class PDFKit {
    ...
    public static String createPDF(Object data, String fileName){
        ...
        try {
            ...
            //设置输出路径
            String outPath = PDFKit.class.getClassLoader().getResource("").getPath() +"pdf/" +System.currentTimeMillis()+".pdf";
            kit.setSaveFilePath(outPath);
